...
def plan_path(start=(50, 50, 0),
    ...
    logger.info(f"CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCccc: {canvas}")
    # if not is_valid_point(start_x, start_y, canvas):
    #     raise ValueError("Start point is on an obstacle.")
    # if not is_valid_point(goal_x, goal_y, canvas):
    #     raise ValueError("Goal point is on an obstacle.")
    # # logger.info(f"CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCccc: {canvas}")
    ...
    logger.info(f"SPPPPPPPPPPaaaaaaaaaaaaaaaaaatttttttttttthhhhhhhhhhhhhhh: {path_gen}")
    canvas_height = 300.0 
