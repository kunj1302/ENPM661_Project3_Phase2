...
from launch.event_handlers import (
    OnExecutionComplete, OnProcessExit,
...
def generate_launch_description():
    ...
    launch_falcon_sim = ExecuteProcess(
        cmd=[
            './Falcon.sh',
            '-scenario=/home/tirth/falconsim/AStarPlanningProject/Scenarios/AMRPathPlanning/AMRPathPlanning.usda'
        ],
        cwd="/home/tirth/duality/falconsim/",
        shell=True
    )
    ...
    # Delay launching the A* node by 5 seconds.
    delayed_astar_node = TimerAction(
        period=7.0,  # Wait 5 seconds
        actions=[astar_control_node]
    )
